  ...
  en: {
    ...
    services: {
      ...
      items: {
        ...
        gym: { title: "Gym Area", desc: "Strength, hangboards, Moonboard and Campusboard — a dedicated training zone to level up." },
    ...
    about: {
      eyebrow: "About us",
      title: "About The West",
      subtitle: "Indoor climbing in the heart of Portugal's west coast — Peniche.",
      p1: "The West Climbing Center is an indoor climbing gym in Peniche. Climbing is more than a sport — it's a lifestyle.",
  ...
  pt: {
    ...
    services: {
      ...
      items: {
        ...
        gym: { title: "Zona de Ginásio", desc: "Força, hangboards, Moonboard e Campusboard — zona de treino dedicada para evoluíres." },
    ...
    about: {
      eyebrow: "Sobre nós",
      title: "Sobre o The West",
      subtitle: "Escalada indoor no coração da costa oeste de Portugal — Peniche.",
      p1: "O The West Climbing Center é um ginásio de escalada indoor em Peniche. Escalar é mais do que um desporto — é um estilo de vida.",
